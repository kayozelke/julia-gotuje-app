                    ...
                    <article class="entry">
                        ...
                        <div class="row">
                            <div class="column lg-12">
                                <p class="lead">
                                    ...
                                    Morbi tincidunt, orci ac convallis aliquam, lectus turpis varius lorem, eu posuere
                                    nunc justo tempus leo.
                                    Donec mattis, purus nec placerat bibendum. Aut magni nemo rerum iure illo. Odit
                                    aperiam doloribus fuga qui architecto
                                    consectetur rerum commodi. Quidem nihil molestiae veritatis quis. Inventore non
                                    voluptatem ratione magni nemo.
                                </p>
                            </div>
                        </div> <!-- end row -->
                        ...
                        <div class="row">
                            ...
                            <div class="column lg-6 tab-12">
                                ...
                                <p><a href="#"><img width="120" height="120" class="u-pull-left"
                                            alt="sample-image" src="{{ asset('front/images/sample-image.jpg') }}"></a>
                                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec libero. Suspendisse
                                    bibendum.Cras id urna. Morbi
                                    tincidunt, orci ac convallis aliquam, lectus turpis varius lorem, eu posuere nunc
                                    justo tempus leo. Donec mattis,
                                    purus nec placerat bibendum, dui pede condimentum odio, ac blandit ante orci ut
                                    diam. Cras fringilla magna.
                                    Phasellus suscipit, leo a pharetra condimentum, lorem tellus eleifend magna, eget
                                    fringilla velit magna id
                                ...
                                <p>
                                    ...
                                    Morbi tincidunt, orci ac convallis aliquam, lectus turpis varius lorem, eu posuere
                                    nunc justo tempus leo.
                                    Donec mattis, purus nec placerat bibendum, dui pede condimentumodio, ac blandit ante
                                    orci ut diam.
                                </p>
                            ...
                            <div class="column lg-6 tab-12">
                                ...
                                <p class="drop-cap">Far far away, behind the word mountains, far from the countries
                                    ...
                                    necessary regelialia. Morbi tincidunt, orci ac convallis aliquam, lectus turpis
                                    varius lorem,
                                    euposuere nunc justo tempus leo. Donec mattis, purus nec placerat bibendum, dui pede
                                    condimentum odio,
                                    ac blandit ante orci ut diam. Cras fringilla magna. Phasellus suscipit, leo a
                                ...
                                <p><small>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec
                                        libero.</small></p>
                        ...
                        <div class="row u-add-half-bottom">
                            ...
                            <div class="column lg-6 tab-12">
                                ...
                                <dl class="dictionary-style">
                                    ...
                                    <dd>This is a 2<sup>nd</sup> definition for a single term. A <code>dt</code> may be
                                        followed by multiple <code>dd</code>s.</dd>
                                </dl>
                        ...
                        <div class="row u-add-half-bottom">
                            ...
                            <div class="column lg-6 tab-12">
                                ...
                                <p>Doloremque dolor voluptas est sequi omnis. Pariatur ut aut. Sed enim tempora qui
                                    veniam qui cum vel.
                        ...
                        <div class="row u-add-half-bottom">
                            ...
                            <div class="column lg-6 tab-12">
                                ...
                                <figure>
                                    <img src="{{ asset('front/images/wheel-500.jpg') }}"
                                        srcset="{{ asset('front/images/wheel-1000.jpg') }} 1000w, 
                                                     {{ asset('front/images/wheel-500.jpg') }} 500w"
                            ...
                            <div class="column lg-6 tab-12">
                                ...
                                <form>
                                    <div>
                                        ...
                                        <input class="u-fullwidth" type="email" placeholder="test@mailbox.com"
                                            id="sampleInput">
                                    </div>
                                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="lg-8 tab-7 mob-12 column">
                                <p>
                                    ...
                                    nec dictum nunc tortor id urna. Suspendisse dapibus ullamcorper pede. Vivamus ligula
                                    ipsum,
                                    faucibus at, tincidunt eget, porttitor non, dolor. Integer faucibus, eros ac
                                    molestie placerat, enim tellus varius lacus,
                                    nec dictum nunc tortor id urna. Suspendisse dapibus ullamcorper pede. Vivamus ligula
                                    ipsum,
                                    faucibus at, tincidunt eget, porttitor non, dolor.
                                </p>
