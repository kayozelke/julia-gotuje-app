...
<body id="top">
    ...
    <div id="page" class="s-pagewrap {{ isset($isHomePage) && $isHomePage ? 'custom-home' : '' }}">
        ...
        <header id="masthead" class="s-header">
            ...
            <div class="row s-header__navigation">
                ...
                <nav class="s-header__nav-wrap">
                    ...
                    {{-- <ul class="s-header__nav burger_mod"> --}}
                        <li class="current-menu-item"><a href="{{ route('home') }}" title="">Strona główna</a></li>
                        <li class="has-children">
                            <a href="{{ route('main_categories') }}" title="" class="">Kategorie</a>
                            <ul class="sub-menu">
            ...
            @include('front.components.header_search') <!-- end s-header__search -->
