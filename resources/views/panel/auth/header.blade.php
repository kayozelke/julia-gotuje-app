      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            ...
            {{-- <a href="javascript:void(0);" class="navbar-menu-toggle-side menu-link text-large ms-auto d-block d-xl-none">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Components -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Obiekty</span></li>
            {{-- Categories  --}}
        ...
        <div class="layout-page">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset('panel/assets/img/avatars/user_1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
          ...
          {{-- custom navbar --}}
          @include('panel.auth.custom_navbar')
